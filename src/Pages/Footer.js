    ...
    return (
      ...
      <div className="place-self-center mt-20 md:place-self-end md:mt-0">
        <div className="flex gap-4 place-self-center md:place-self-end">
          ...
          <a href="https://www.youtube.com/channel/UCStyBAt843N8NNnOHr2CW2w" target='_blank' rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="https://www.facebook.com/soroarhossainmia" target='_blank' rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <div>
          <p><span className='text-bold'>Email:</span><span className="pl-2 text-orange-500 font-semibold">miasoroar@gmail.com</span> </p>
          <p>Phone:<span className="pl-2 text-orange-500 font-semibold">  +880 1933705154 </span></p>
          <p>©{date} - All Right Reserved By<span className="pl-2 text-orange-500 font-semibold">Soroar Mia</span> </p>
        </div>
